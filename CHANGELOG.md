...
- **GLOBAL RULES simplified** — Removed the "Never store or reference past sessions" rule, which was redundant for stateless models and potentially counterproductive for models with persistent memory features.
